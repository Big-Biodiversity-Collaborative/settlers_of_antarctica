...
2. What is the correct code for loading up the helpfile for `install_github()` function from the devtools packge that you haven't loaded into your working environment?  
a. `??install_github`  
b. `?install_github`  
...
10. What value is printinted in the console from the code below.  
