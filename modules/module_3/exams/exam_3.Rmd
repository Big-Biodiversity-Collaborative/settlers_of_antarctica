...
### Question 4
Write code using tidyverse/dplyr syntax that computes a summary of the 
dataframe that includes an average weight and testosterone level for each seal
over the course of the year and the standard deviation of weight and 
testosterone level for each seal. Account for the fact that there is some 
